...
const useLatestRelease = () => {
  const { data, error } = useSWR(
    `https://github.com/A-Waked/AIDemos/releases/latest`,
    fetcher
  )
      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className={clsx("col col--4", styles.info)}>
            <p>
              The downloads for the demos will be listed here. Currently empty as there are no releases on the github repo.
            </p>
            <div className={styles.platforms}>
              <h3>Planned Supported Platforms</h3>
              <div>
                <DiApple size={size} />
                <DiWindows size={size} />
                <DiLinux size={size} />
